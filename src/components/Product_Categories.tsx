...
import programmer from '../assets/wireless_prog.jpg'
...
const categories: Category[] = [
    ...
    { id: 8, topic: 'Hotel Series Smart Locks', image: hotel_lock },
    { id: 9, topic: 'Hotel Automation', image: hotel_automation },
    { id: 10, topic: 'Hotel Accessories', image: hotel_accesories },
    { id: 11, topic: 'Mifare Encorders', image: encoder },
    { id: 12, topic: 'Wireless Programmer', image: programmer },
];

const Product_Categories = () => {
    return (
        <div className="mr-30 ml-30 mt-5 mb-10">
            <div>
