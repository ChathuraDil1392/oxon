...
const FeatureIcon: React.FC<{ type: FeatureType }> = ({ type }) => {
  switch (type) {
    ...
    case 'key':
      return (
        <LuKey
          className='w-6 h-6 border rounded m-1 p-0.5 border-blue-900 text-blue-900 transition-colors'
    ...
    <div className=''>
      <section className='bg-white py-12 px-4 sm:px-6 lg:px-1 max-w-7xl mx-auto font-sans mb-2'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch'>
          ...
          <div
            className='lg:col-span-1 relative flex flex-col justify-between overflow-hidden rounded-lg bg-gray-100 p-6 min-h-125 shadow-sm group hover:scale-105 transition-transform duration-200 ease-in-out '
            style={{
