...
const SocialIcons: React.FC = () => (
    <div className="flex items-center gap-3 mt-6">
        <span className="w-5 h-5 rounded-full bg-red-600 flex items-center justify-center text-[10px] font-black font-sans cursor-pointer text-white">4</span>
        <span className="w-5 h-5 rounded-full bg-emerald-600 flex items-center justify-center text-[10px] font-black font-sans cursor-pointer text-white">▲</span>
        <span className="w-5 h-5 rounded-full bg-blue-600 flex items-center justify-center text-[10px] font-black font-sans cursor-pointer text-white">S</span>
    </div>
);
        ...
        <footer className="w-full bg-black text-blue-950 py-14 px-6 md:px-12 font-sans border-t border-gray-900">
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div className="lg:col-span-3 flex flex-col justify-between h-full">
                    <div>
                        ...
                        <p className="text-xs text-gray-400 leading-relaxed max-w-xs">
                            Oxon Maldives Pvt Ltd &mdash; Smart Automation for Homes &amp; Hospitality. Exclusive Orbita Partner in the Maldives.
                        </p>
                    </div>
                ...
                <div className="lg:col-span-5 grid grid-cols-1 md:grid-cols-3 gap-8 pt-4">
                    {/* Popular Categories */}
                    <div>
                        <h3 className="text-sm font-bold text-white tracking-wide mb-5">Popular Categories</h3>
                        <ul className="space-y-4 text-xs text-gray-400">
                            <li><a href="#" className="hover:text-white transition-colors">Smart Home Solutions</a></li>
                            <li><a href="#" className="hover:text-white transition-colors">Hospitality Smart Solutions</a></li>
                        </ul>
                    </div>

                    {/* Product Type */}
                    <div>
                        <h3 className="text-sm font-bold text-white tracking-wide mb-5">Product Type</h3>
                        <ul className="space-y-4 text-xs text-gray-400">
                    ...
                    {/* Useful Links */}
                    <div>
                        <h3 className="text-sm font-bold text-white tracking-wide mb-5">Useful Links</h3>
                        <ul className="space-y-4 text-xs text-gray-400">
                            <li><a href="#" className="hover:text-white transition-colors">About Us</a></li>
                            <li><a href="#" className="hover:text-white transition-colors">Contact Us</a></li>
                            <li><a href="#" className="hover:text-white transition-colors">All Products</a></li>
                            <li><a href="#" className="hover:text-white transition-colors">Refrences</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="lg:col-span-4 lg:border-l lg:border-gray-800 lg:pl-10 w-full pt-4">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-3">
                        ...
                        <button
                            type="submit"
                            className="w-full bg-gray-100 text-gray-400 hover:text-gray-900 font-semibold py-2.5 text-xs tracking-widest rounded-xs transition-all duration-200 cursor-pointer hover:bg-white"
                        >
                            SEND
                        </button>
                    </form>
