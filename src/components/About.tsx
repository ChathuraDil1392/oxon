...
const teamAvatars = [tech_2, worker_1, oxon];
...
const About = () => {
  const timelineData: TimelineYear[] = [
    ...
    {
      year: 2018,
      title: 'Orbita Exclusive Seller for Maldives',
      image: oxon_logo,
    },
  ...
  const strategies: StrategyItem[] = [
    {
      ...
      icon: (
        <svg
          className='w-24 h-24 text-neutral-800 drop-shadow-xl'
          viewBox='0 0 24 24'
          fill='currentColor'
        >
          {/* 3D Tetrahedron/Pyramid representation */}
          <path
            d='M12 2L2 18h20L12 2zm0 4.5L18.5 16.5h-13L12 6.5z'
            opacity='0.8'
          />
    ...
    },
    {
      ...
      icon: (
        <svg
          className='w-20 h-20 text-neutral-900 drop-shadow-md'
          viewBox='0 0 24 24'
          fill='currentColor'
        >
  ...
  return (
    <>
      <section className='bg-[#000b2f] text-white py-20 px-6 md:px-16 font-sans'>
        <div className='max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-start'>
          ...
          <div className='lg:col-span-6 space-y-12 lg:pt-16'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-6'>
              ...
              <div className='relative rounded-2xl overflow-hidden aspect-4/3 bg-neutral-900'>
                <div className='absolute top-4 left-4 z-10 flex space-x-2'>
                  <span className='bg-black/60 backdrop-blur-md text-[10px] px-3 py-1 rounded-full text-white font-medium'>
                    Tech Blog
                  </span>
                  <span className='bg-black/60 backdrop-blur-md text-[10px] px-3 py-1 rounded-full text-gray-300'>
                    Trends
                  </span>
                </div>
                <img
            ...
            <p className='text-white/90 text-sm leading-relaxed max-w-xl'>
              ...
              nullam. Molestie nunc non blandit massa enim nec. Felis bibendum
              ut tristique et egestas quis ipsum suspendisse ultrices. Eros in
      ...
      <section className='bg-slate-900 text-white py-20 px-6 md:px-16 font-sans overflow-hidden'>
        <div className='max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center'>
          ...
          <div className='lg:col-span-6 space-y-8'>
            ...
            <h2 className='text-4xl md:text-5xl font-bold leading-tight tracking-tight max-w-xl'>
              Your Gateway To{' '}
              <span className='text-blue-400'>Online Excellence</span> Dream Big
              In Pixels.
            </h2>
            ...
            <div className='pt-10 space-y-6 max-w-xl'>
              ...
              <div className='relative pt-4'>
                ...
                <div
                  ...
                  style={{
                    width: `${(activeIdx / (timelineData.length - 1)) * 100}%`,
                  }}
                ></div>
            ...
            <div className='relative rounded-2xl overflow-hidden bg-neutral-900 border border-neutral-800 shadow-2xl w-full max-w-xl aspect-4/3'>
              ...
              <div className='absolute bottom-12 left-12 group cursor-pointer z-20'>
                <div className='relative w-24 h-24 bg-black rounded-full flex items-center justify-center shadow-2xl border border-neutral-800'>
                  {/* SVG Text Wrapper */}
                  <svg
                    className='absolute w-full h-full animate-[spin_12s_linear_infinite] p-1.5'
                    viewBox='0 0 100 100'
                  >
                    <defs>
                      <path
        ...
        <div className='max-w-7xl mx-auto space-y-16 flex flex-col items-center'>
          ...
          <div className='text-center space-y-4'>
            ...
            <h2 className='text-3xl md:text-4xl font-bold tracking-tight'>
              Thoughtful Digital{' '}
              <span className='text-blue-400'>Strategies</span>
            </h2>
          </div>
      ...
      <section className='bg-[#1c1c1c] text-white py-20 px-6 md:px-16 font-sans'>
        <div className='max-w-7xl mx-auto space-y-14 flex flex-col items-center'>
          ...
          <div className='text-center space-y-3'>
            ...
            <h2 className='text-3xl md:text-4xl font-bold tracking-tight'>
              Worldwide Digital <span className='text-blue-400'>Brand</span>{' '}
              Associates
            </h2>
          </div>
